  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="pb-20 px-4">
        <div className="container max-w-6xl mx-auto">
          <div className="bg-gradient-to-br from-muted to-background border-2 border-dashed border-border rounded-3xl p-16 text-center">
      ...
      <section className="py-20 px-4 bg-muted">
        <div className="container max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">Des résultats mesurables pour nos clients</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="p-6">
              ...
              <p className="text-muted-foreground">Secteurs couverts</p>
            </div>
          </div>
        </div>
      </section>
